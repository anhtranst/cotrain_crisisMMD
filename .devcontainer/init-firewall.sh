...
# ============================================================================
# Allowed domains - aligned with Claude Code proxy allowlist
# ============================================================================
for domain in \
    # --- Anthropic services ---
    "api.anthropic.com" \
    ...
    # --- Python packages (PyPI + build deps) ---
    "pypi.org" \
    "files.pythonhosted.org" \
    "pythonhosted.org" \
    # --- Ubuntu apt (for build dependencies) ---
    "archive.ubuntu.com" \
    "security.ubuntu.com" \
    # --- npm / yarn ---
    "registry.npmjs.org" \
    ...
    "index.crates.io" \
    "static.crates.io" \
    # --- GitHub (domain itself, beyond CIDR ranges above) ---
    "github.com" \
