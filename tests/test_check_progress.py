...
from scripts.check_progress import parse_study_log, parse_timestamp, format_duration, print_progress


SAMPLE_LOG = textwrap.dedent("""\
    2026-01-15 10:00:00,000 - Optuna study: humanitarian/text_only budget=50 seed=1 | target=10 trials
...
class TestParseStudyLog(unittest.TestCase):
    ...
    def test_parses_event_info(self):
        ...
        self.assertEqual(info["label"], "humanitarian/text_only")
...
class TestPrintProgressTotalStudies(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Study 1: humanitarian/text_only budget=50 seed=1
        d1 = base / "humanitarian/text_only" / "50_set1" / "trials_10"
        d1.mkdir(parents=True)
        with open(d1 / "study.log", "w") as f:
            f.write(SAMPLE_LOG)

        # Study 2: informative/text_only budget=50 seed=1 (all 10 trials done)
        d2 = base / "informative/text_only" / "50_set1" / "trials_10"
        d2.mkdir(parents=True)
        completed_log = textwrap.dedent("""\
            2026-01-15 10:00:00,000 - Optuna study: informative/text_only budget=50 seed=1 | target=10 trials
            2026-01-15 10:00:01,000 - --- Trial 1/10 ---
